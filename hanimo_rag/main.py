"""FastAPI application for hanimo_rag."""
...
from hanimo_rag.api import ingest, search, graph, admin, collections, generate, apps
...
app = FastAPI(
    ...
    description="""
hanimo_rag is a lightweight RAG engine that runs entirely on PostgreSQL.
...
If no API keys are configured (`HANIMO_RAG_API_KEYS` is empty), all requests are allowed.
